$ROOT = "d:\html\erp"
$ERP_REPO = Join-Path $ROOT "ERP_Repo"
$ALL_ALL = Join-Path $ROOT "All\All"
$APP_FILES_DIR = Join-Path $ALL_ALL "Application Files"
...
Package-ClickOnceApp -appName "ERP_Khach" -folderName "ERP_Khach_1_0_0_2" -appVersion "1.0.0.2" -srcDir (Join-Path $ERP_REPO "Goi_Cai_Dat_ERP") -mainExe "ERP_Khach.exe"

# 2. ERP_BanHang
Package-ClickOnceApp -appName "ERP_BanHang" -folderName "ERP_BanHang_1_0_0_8" -appVersion "1.0.0.8" -srcDir (Join-Path $ERP_REPO "ERP_BanHang\ERP_BanHang\bin\Release") -mainExe "ERP_BanHang.exe"

# 3. ERPKho1
Package-ClickOnceApp -appName "ERPKho1" -folderName "ERPKho1_1_0_0_1" -appVersion "1.0.0.1" -srcDir (Join-Path $ERP_REPO "ERPKho1\bin\Release") -mainExe "ERPKho1.exe"

# 4. ERP_Logistics
Package-ClickOnceApp -appName "ERP_Logistics" -folderName "ERP_Logistics_1_0_0_0" -appVersion "1.0.0.0" -srcDir (Join-Path $ERP_REPO "ERP_Logistics\bin\Release") -mainExe "ERP_Logistics.exe"

# 5. ERP_NhanSu
Package-ClickOnceApp -appName "ERP_NhanSu" -folderName "ERP_NhanSu_1_0_0_0" -appVersion "1.0.0.0" -srcDir (Join-Path $ERP_REPO "ERP_NhanSu\bin\Release") -mainExe "ERP_NhanSu.exe"

# 6. KE_TOAN_TAI_CHINH
Package-ClickOnceApp -appName "KE_TOAN_TAI_CHINH" -folderName "KE_TOAN_TAI_CHINH_1_0_0_0" -appVersion "1.0.0.0" -srcDir (Join-Path $ERP_REPO "KE_TOAN_TAI_CHINH\bin\Release\net48") -mainExe "KE_TOAN_TAI_CHINH.exe"
