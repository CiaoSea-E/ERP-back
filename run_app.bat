...
echo   Gom: ERP_Khach, ERP_BanHang, ERP_NhanSu, ERPKho1, ERP_Logistics
echo ================================================================

powershell -Command "Stop-Process -Name 'ERP_Khach','ERP_BanHang','ERP_NhanSu','HR_Management','ERPKho1','ERP_Logistics' -Force -ErrorAction SilentlyContinue"
