...
Package-ClickOnceApp -appName "ERP_Khach" -folderName "ERP_Khach_1_0_0_4" -appVersion "1.0.0.4" -srcDir (Join-Path $ERP_REPO "Goi_Cai_Dat_ERP") -mainExe "ERP_Khach.exe"

# 2. ERP_BanHang
Package-ClickOnceApp -appName "ERP_BanHang" -folderName "ERP_BanHang_1_0_0_9" -appVersion "1.0.0.9" -srcDir (Join-Path $ERP_REPO "ERP_BanHang\ERP_BanHang\bin\Release") -mainExe "ERP_BanHang.exe"
...
# 5. ERP_NhanSu
Package-ClickOnceApp -appName "ERP_NhanSu" -folderName "ERP_NhanSu_1_0_0_3" -appVersion "1.0.0.3" -srcDir (Join-Path $ERP_REPO "ERP_NhanSu\bin\Release") -mainExe "ERP_NhanSu.exe"
